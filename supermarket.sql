...
INSERT INTO Logins(LoginTypeID, Username, Password)
	VALUES(1, N'buu', N'buu'),
          ...
          (2, N'dat', N'dat')
GO
INSERT INTO Employees(LoginID, LastName, FirstName, PositionID, BirthDate, Address, City, District, Email)
	VALUES(1, N'Duong Tan', N'Buu', 1, '2000-07-03', N'some where on Earth', N'Ho Chi Minh', N'6', N'1851010015buu@ou.edu.vn'),
          (2, N'Diep Hoang', N'Phi', 1, '2000-01-01', N'some where on Earth', N'Quang Ngai', N'Go Vap', N'1851010097phi@ou.edu.vn'),
          (3, N'Bui Xuan', N'Hieu', 1, '2000-01-01', N'some where on Earth', N'Ho Chi Minh', N'Go Vap', N'1851010045hieu@ou.edu.vn'),
          (4, N'Tran Kim', N'Bao', 1, '2000-01-01', N'some where on Earth', N'Ho Chi Minh', N'Go Vap', N'1851010014bao@ou.edu.vn'),
          (5, N'Dao Tien', N'Dat', 2, '2000-01-01', N'some where in North', N'Hai Phong', N'Go Vap', N'1851010023dat@ou.edu.vn')
GO
--____________________________________________________________________________________________________
